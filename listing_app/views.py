...
from .import models
from .models import Car, UserProfile, Review, Address, Order
...
def car_detailed(request, car_id):
    ...
    if request.method == 'POST':
        ...
        reviewer = Review.objects.create(review_title=title, reviewer_name=author, email=email, review=comment, car_reviewed=obj_reviewed)
        reviewer.save()

...
class UserProfile(models.Model):
    ...
    profile_user = models.OneToOneField(
        User, on_delete=models.CASCADE, default=7)
    ...
    profile_seller = models.CharField(
        max_length=100, choices=SELLER, default='Dealer')
...
class Car(models.Model):
    ...
    image = models.ImageField(
        verbose_name='Car Image Side', upload_to='listing/')
    car_front = models.ImageField(
        verbose_name='Car Image front', upload_to='media/', blank=True, null=True)
    car_back = models.ImageField(
        verbose_name='Car Image back', upload_to='media/', blank=True, null=True)
    car_interior = models.ImageField(
        verbose_name='Car Image Interior', upload_to='media/', blank=True, null=True)
    car_motion = models.ImageField(
        verbose_name='Car Image in Motion', upload_to='media/', blank=True, null=True)
    ...
    car_transmission = models.CharField(
        choices=TRANSMISIION, default='automatic', max_length=100)
    # Mechanical features
    car_cargo_capacity_space = models.PositiveIntegerField(
    ...
    car_season_tires = models.CharField(
        choices=OPTIONS, default='N/A', max_length=100)
    car_power_glass_sunroof = models.CharField(
        choices=OPTIONS, default='Automatic', max_length=100)
    car_tire_size = models.CharField(max_length=50)
    car_ac_climate_control = models.CharField(
        choices=OPTIONS, default='automatic', max_length=100)
    car_built_hard_drive = models.CharField(
        choices=AUTO, default='Yes', max_length=100)
    car_hd_radio = models.CharField(
        choices=OPTIONS, default='automatic', max_length=100)
    car_seats = models.CharField(
        choices=OPTIONS, default='automatic', max_length=100)
    ...
    car_user = models.ForeignKey(
        User, default=0, related_name='owner', on_delete=models.CASCADE)
...
class Review(models.Model):
    ...
    car_reviewed = models.ForeignKey(
...
class Address(models.Model):
    ...
    customer = models.ForeignKey(
        User, null=True, related_name='customer', on_delete=models.CASCADE)
    profile_address = models.TextField(
        verbose_name='Address', blank=True, null=True)
    profile_country = models.CharField(
        choices=COUNTRY, default='Nigeria', max_length=100, blank=True, null=True)
